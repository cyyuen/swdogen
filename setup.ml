...
(* OASIS_START *)
<<<<<<< HEAD
(* DO NOT EDIT (digest: de8858135dfa66bec857f31fa9b13afe) *)
=======
(* DO NOT EDIT (digest: 5ac4d79b2d0c67909617f2f5fe374035) *)
>>>>>>> a5093d1b54ee3dc9dbc751f4011405aa40d28874
(*
...
let setup_t =
  {
     ...
     doc = [("swdogen", OCamlbuildDocPlugin.doc_build "swdogen")];
     ...
     clean_doc = [("swdogen", OCamlbuildDocPlugin.doc_clean "swdogen")];
     distclean = [];
     distclean_test =
       [
          ("test",
     ...
     package =
       {
          ...
          authors = ["C.Y. yuen"];
          homepage = Some "https://github.com/dotcy/swdogen/wiki";
          synopsis = "SWagger DOcumentation GENerator";
          description =
            Some
              "Scan and parse your source code and generate valid swagger document feed to swagger-ui";
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage
                             ("atdgen",
                               Some (OASISVersion.VGreaterEqual "1.2.3"));
                      ...
                      },
                   {
                      ...
                      lib_pack = true;
                      lib_internal_modules = ["Swgparser"; "Swglexer"; "Url"];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dotcy/swdogen.git";
                      src_repo_browser =
                        Some "https://github.com/dotcy/swdogen";
     ...
     oasis_version = "0.3.0";
<<<<<<< HEAD
     oasis_digest = Some "\158YÕ©\025ENéM\139\158·\142nÅB";
=======
     oasis_digest = Some "\213\003M\030\149\189\004S-%\223~\128\188ki";
>>>>>>> a5093d1b54ee3dc9dbc751f4011405aa40d28874
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
